...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  defaultMessage: "Esse valor está inválido.",
  type: {
    email:        "E-mail inválido.",
    url:          "Digite uma URL válida.",
    number:       "Utilize apenas números.",
    integer:      "Utilize apenas inteiros.",
    digits:       "Utilize apenas dígitos.",
    alphanum:     "Utilize apenas caracteres alfanumericos."
  },
  notblank:       "This value should not be blank.",
  required:       "Campo obrigatório",
  pattern:        "Esse valor está inválido.",
  min:            "This value should be greater than or equal to %s.",
  max:            "This value should be lower than or equal to %s.",
  range:          "This value should be between %s and %s.",
  minlength:      "Esse campo deve conter no mínimo %s caracteres.",
  maxlength:      "Esse campo deve conter no máximo %s caracteres.",
  length:         "Preencha com %s caracteres.",
  mincheck:       "You must select at least %s choices.",
  maxcheck:       "You must select %s choices or fewer.",
  check:          "You must select between %s and %s choices.",
  equalto:        "A senha e sua confirmação devem ser iguais."
});
